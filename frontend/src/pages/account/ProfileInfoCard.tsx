    ...
    {editing ? (
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="rounded-xl p-4 bg-gray-50 dark:bg-white/[0.03]">
          ...
          <p className="font-medium text-gray-700 dark:text-gray-300 mt-1">{user?.name || "Not set"}</p>
        </div>
        <div className="rounded-xl p-4 bg-gray-50 dark:bg-white/[0.03]">
          <p className="text-xs text-gray-500 uppercase tracking-wider">Phone Number</p>
          <p className="font-medium text-gray-700 dark:text-gray-300 mt-1">{user?.phone || "Not set"}</p>
        </div>
        <div className="rounded-xl p-4 bg-gray-50 dark:bg-white/[0.03]">
          <p className="text-xs text-gray-500 uppercase tracking-wider">Email Address</p>
          <p className="font-medium text-gray-700 dark:text-gray-300 mt-1 break-all">{user?.email}</p>
        </div>
        <div className="rounded-xl p-4 bg-gray-50 dark:bg-white/[0.03]">
