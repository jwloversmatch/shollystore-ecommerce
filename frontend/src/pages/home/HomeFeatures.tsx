...
const HomeFeatures = () => (
  <section className="bg-[#FCFAF5] dark:bg-[#121314] py-16 md:py-20">
      ...
      >
        {features.map((f, i) => (
          <motion.div
            ...
            className="bg-[#FCFAF5] dark:bg-[#17181A] border border-gray-200 dark:border-white/5 rounded-2xl p-5 md:p-6 transition-all cursor-default relative overflow-hidden"
          >
            <div
