...
import { ChevronLeft, ChevronRight, Sparkles, ArrowRight, Shirt, Smartphone, ShoppingBag, Zap, Truck, ShieldCheck, Star, TrendingUp } from "lucide-react";
...
const categories = [
  ...
  { icon: <Smartphone className="w-4 h-4" />, name: "Electronics", color: "#3b82f6" },
  { icon: <ShoppingBag className="w-4 h-4" />, name: "Groceries", color: "#10b981" },
