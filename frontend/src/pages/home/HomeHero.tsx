    ...
    <section className="relative max-w-7xl mx-auto px-6 pt-20 md:pt-28 pb-16 grid md:grid-cols-2 items-center gap-14">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-black text-white leading-[1.06]"
        >
          {heroPart2 ? (
            <>
              {heroPart1}{" "}
        ...
        >
          <motion.button
            whileHover={{
              scale: 1.04,
              boxShadow: `0 14px 36px ${ACCENT}50`,
            }}
            whileTap={{ scale: 0.96 }}
            onClick={() =>
              document
          ...
          <div className="flex items-center gap-2">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-8 h-8 rounded-full border-2 border-[#0A0A0B] overflow-hidden bg-[#1c1c1c]"
              >
                {/* placeholder; product images are not easily passed here, but original code uses displayProducts; 
                    we could pass an array of image URLs, but for simplicity we keep the same behavior as before */}
              </div>
            ))}
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              boxShadow: `0 0 0 4px ${ACCENT}, 0 24px 80px rgba(0,0,0,0.7), 0 0 60px ${ACCENT}20`,
            }}
          >
            {heroSlides && heroSlides.length > 0 ? (
              ...
              <div className="w-full h-full bg-[#1c1c1c] flex items-center justify-center text-gray-600">
                No images
              </div>
            )}
              ...
              {heroSlides.map((_: HeroSlide, i: number) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    i === currentIndex ? "w-6" : "w-1.5 bg-white/20"
                  }`}
