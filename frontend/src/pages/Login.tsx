...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none bg-[radial-gradient(rgba(0,0,0,0.03)_1px,transparent_1px)] dark:bg-[radial-gradient(rgba(255,255,255,0.025)_1px,transparent_1px)] bg-[length:28px_28px]"
        aria-hidden="true"
      />
      {/* Main card */}
      <div
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(148deg,#1c0a00 0%,#130800 40%,#0A0A0B 100%)",
          }}
          aria-hidden="true"
        >
          <div
          ...
          <div className="flex flex-col items-center gap-7">
            <div className="relative">
              ...
              >
                <div className="text-[9px] text-gray-600 font-extrabold uppercase tracking-wider">
                  Rating
                </div>
                <div
            ...
            {[
              {
                ...
                label: "Secure & encrypted login",
              },
              {
                icon: <Zap className="w-3.5 h-3.5" />,
                label: "Instant order tracking",
              },
              {
        ...
        <div className="flex flex-col justify-center p-6 sm:p-8 md:p-10 lg:p-12 bg-[#FCFAF5] dark:bg-[#141414]">
          ...
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-black text-gray-900 dark:text-white leading-tight">
              Sign in to
              <br className="hidden sm:block" /> your account
            </h1>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label
                  ...
                  className="block text-[10px] font-extrabold uppercase tracking-widest text-gray-500 dark:text-gray-400"
                >
                  Password
                </label>
                <Link
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <span className="text-[11px] text-gray-500 dark:text-gray-600 font-semibold shrink-0">
              or continue as
            </span>
            <div className="flex-1 h-px bg-gray-200 dark:bg-white/[0.06]" />
          </div>
