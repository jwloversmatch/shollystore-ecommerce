...
const InfoRow = ({
  ...
  >
    <p className="text-[9px] font-extrabold uppercase tracking-[0.2em] text-gray-600 mb-1.5">
      {label}
    </p>
    <p
      className={`text-white font-semibold text-sm ${mono ? "font-mono tracking-widest" : ""}`}
    >
...
const Label = ({
  ...
  <div className="flex items-baseline gap-2 mb-2">
    ...
    {hint && (
      <span className="text-gray-700 text-[10px] normal-case tracking-normal">
        {hint}
      </span>
    )}
  </div>
    ...
    >
          ...
          <div className="space-y-5" role="region" aria-label="View settings">
            ...
            <DarkCard>
              <div className="p-6 md:p-7">
                ...
                >
                  <div>
                    <p className="text-[9px] font-extrabold uppercase tracking-[0.2em] text-gray-600 mb-1">
                      Landing Mode
                    </p>
            ...
            <DarkCard accentColor="#10b981">
              <div className="p-6 md:p-7">
                ...
                {hasPayment ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold text-sm font-mono tracking-widest">
                          {settings?.bankAccountNumber || "—"}
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    className="flex items-center gap-3 p-5 rounded-xl text-gray-600"
                    style={{
                      background: "#1c1c1c",
                      border: "1px solid rgba(255,255,255,0.06)",
                    }}
                  >
                    ...
                    <p className="text-sm">
                      ...
                      <strong className="text-white">Edit Settings</strong> to
                      add them.
                    </p>
                  </div>
                )}
              ...
              <div className="p-6 md:p-7">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="push-title"
                      className="text-[10px] font-extrabold uppercase tracking-widest text-gray-500 block mb-2"
                    >
                      Notification Title
                    </label>
                    <input
          ...
          <div className="space-y-5" role="region" aria-label="Edit settings">
            ...
            <DarkCard>
              <div className="p-6 md:p-7">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label hint='Use " | " to split title'>Hero Title</Label>
                    <input
                      {...register("heroTitle")}
            ...
            <DarkCard accentColor="#10b981">
              <div className="p-6 md:p-7">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="edit-bank-name" className="sr-only">
                      Bank Name
                    </label>
                    <input
                      id="edit-bank-name"
                  ...
                  <div>
                    <label htmlFor="edit-account-name" className="sr-only">
                      Account Name
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="edit-account-number" className="sr-only">
                      Account Number
                    </label>
                    <input
                      ...
                      className={
                        inputCls(!!errors.bankAccountNumber) +
                  ...
                  <div>
                    <label htmlFor="edit-whatsapp" className="sr-only">
                      WhatsApp Number
                    </label>
                    <input
                      id="edit-whatsapp"
      ...
      >
        ...
        >
          ...
          <ChevronDown
            className={`w-4 h-4 text-gray-600 transition-transform ${showAudit ? "rotate-180" : ""}`}
            aria-hidden="true"
          />
        </button>
        <AnimatePresence>
                      ...
                      {["Field", "Old Value", "New Value", "Admin", "Date"].map(
                        (h) => (
                          <th
                            key={h}
                            scope="col"
                            className="px-5 py-3 text-[9px] font-extrabold uppercase tracking-widest text-gray-600"
                          >
                            {h}
                          </th>
                        ),
                  ...
                  <tbody>
                    {changeLogs.length === 0 ? (
                      <tr>
                        <td
                          colSpan={5}
                          className="px-5 py-8 text-center text-gray-700 text-sm"
                        >
                      ...
                      changeLogs.map((log: ChangeLogItem) => (
                        ...
                        >
                          ...
                          <td className="px-5 py-3 text-gray-600 text-xs max-w-[100px] truncate">
                            {log.oldValue || "—"}
                          </td>
                          <td className="px-5 py-3 text-white text-xs max-w-[100px] truncate">
                            {log.newValue || "—"}
                          </td>
                          <td className="px-5 py-3 text-gray-500 text-xs truncate max-w-[120px]">
                            {log.adminEmail}
                          </td>
