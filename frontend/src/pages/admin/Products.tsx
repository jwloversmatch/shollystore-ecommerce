            ...
            >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
                ...
                <div>
                  ...
                  {/* ── Quick Add Colors ── */}
                  <div className="p-3 rounded-xl bg-[#1c1c1c] border border-white/[0.08] space-y-3 mb-4">
                    <p className="text-[10px] font-extrabold uppercase tracking-widest text-gray-500">
                      Quick Add Colors for a Size
                    </p>
                  ...
                  <div className="space-y-3">
                    {variants.map((v, idx) => (
                      <div
                        key={idx}
                        className="p-3 rounded-xl bg-[#1c1c1c] border border-white/[0.08] space-y-2 relative"
                      >
                        <button
                          type="button"
                ...
                >
                  <div>
                    ...
                    <p className="text-gray-600 text-xs">
                      Show on the homepage Best Sellers section
                    </p>
                  </div>
                  <button
                    type="button"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label
                      className="flex items-center gap-3 px-4 py-3 rounded-xl border border-dashed cursor-pointer transition-colors hover:border-[#e8622a]/40"
                      style={{
                        background: "rgba(255,255,255,0.03)",
                    ...
                    {editingProduct?.images?.length && files.length === 0 && (
                      <div>
                        <p className="text-[10px] text-gray-600 mb-1.5 uppercase font-bold tracking-wider">
                          Current Images
                        </p>
                        <div className="flex gap-2 flex-wrap">
                ...
                {!editingProduct && (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">
                        Send a new arrival email to all subscribers
                      </p>
                    </div>
                    <button
                      type="button"
                    ...
                    >
                      <motion.div
                        animate={{ x: notifyCustomers ? 20 : 2 }}
                        transition={{
                          type: "spring",
                          stiffness: 500,
                          damping: 32,
                  ...
                  <motion.button
                    ...
                    whileHover={
                      !(isSubmitting || uploading)
                        ? { scale: 1.03, boxShadow: `0 12px 28px ${ACCENT}55` }
                        : {}
                    }
                    whileTap={
                      !(isSubmitting || uploading) ? { scale: 0.97 } : {}
                    }
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileHover={!isSendingMarketing ? { scale: 1.04 } : {}}
                      whileTap={!isSendingMarketing ? { scale: 0.97 } : {}}
