...
const Categories = () => {
  ...
  const [newParent, setNewParent] = useState<string>(""); // parent ID, empty = top‑level
  ...
  const handleCreate = async () => {
    ...
    try {
      await createCategory({
        name: newName,
        parent: newParent || null, // send null for top‑level
      }).unwrap();
      setNewName("");
      setNewParent("");
      setIsCreating(false);
                    ...
                    <div className="p-4 md:p-5">
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <option value="">Top‑level (no parent)</option>
                          {categories
                            .filter((c: Category) => c._id !== cat._id) // can't be its own parent
                            .map((c: Category) => (
