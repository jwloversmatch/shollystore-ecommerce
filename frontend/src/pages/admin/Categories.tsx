    ...
    >
      ...
      <div className="flex items-center gap-3.5 flex-1">
        <div
          ...
          style={{ background: isDark ? "#1c1c1c" : "#e5e7eb" }}
        />
              ...
              >
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-3 rounded-xl font-bold transition-colors text-sm"
                    style={{
                      background: inputBg,
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2.5 mt-1 flex-wrap">
                      <span
                        ...
                        style={{ background: tagBg, color: textMuted }}
                      >
                        /{cat.slug}
                      </span>
                      <span
                        ...
                        style={{
                          background: cat.parent ? blueBg : greenBg,
                          color: cat.parent ? blueText : greenText,
                        }}
                      >
                        {cat.parent ? (
                          <>
  ...
  if (isLoading) {
    return (
      <main
        id="main-content"
        tabIndex={-1}
        className="min-h-screen p-4 md:p-6 max-w-4xl mx-auto pb-28 md:pb-10 space-y-5 focus:outline-none"
        style={{
          background: bg,
      ...
      >
        ...
        <div className="space-y-3">
          {Array.from({ length: 5 }).map((_, i) => (
            <CategoryRowSkeleton key={i} isDark={isDark} />
          ))}
        </div>
      </main>
    );
