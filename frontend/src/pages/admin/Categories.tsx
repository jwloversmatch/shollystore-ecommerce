...
// ─── Types ─────────────────────────────────────────────────────────────────────
// The backend returns nested tree nodes.
  ...
  <DarkCardSkeleton>
    ...
    >
      ...
      <div className="flex items-center gap-3.5 flex-1">
        <div
          className="w-11 h-11 rounded-xl shrink-0 animate-pulse"
...
const Categories = () => {
  ...
  // ✅ 2. Helper to flatten tree for the empty state count (strictly typed)
  ...
  // ✅ 4. Recursive component to render indented category rows (strictly typed)
        ...
        <React.Fragment key={cat._id}>
          <motion.div
            ...
            style={{
              ...
              marginLeft: depth > 0 ? `${depth * 20}px` : "0px", // ✅ Visual indentation
            }}
            role="listitem"
          >
            {editingId === cat._id ? (
              <div
                ...
                role="group"
                aria-label={`Editing category: ${cat.name}`}
              >
                <p
                ...
                <div className="space-y-3">
                  <label
                    htmlFor={`edit-category-name-${cat._id}`}
                    className="sr-only"
                  >
                    Category name
                  </label>
                  <input
                    id={`edit-category-name-${cat._id}`}
                    type="text"
                    value={editingName}
                  ...
                  />
                  <label
                    htmlFor={`edit-category-parent-${cat._id}`}
                    className="sr-only"
                  >
                    Parent category
                  </label>
                  <select
                    id={`edit-category-parent-${cat._id}`}
                    value={editingParent}
                  ...
                  >
                    ...
                    {/* ✅ Render tree but exclude itself to prevent circular reference */}
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2.5 mt-1 flex-wrap">
                      ...
                      <span
                        ...
                        style={{
                          background: cat.parent
                            ? "rgba(59,130,246,0.1)"
                            : "rgba(16,185,129,0.1)",
                          color: cat.parent ? "#60a5fa" : "#34d399",
                        }}
                      >
                        {cat.parent ? (
                          <>
  ...
  if (isLoading) {
    return (
      <main
        id="main-content"
        tabIndex={-1}
        className="min-h-screen p-4 md:p-6 pt-16 md:pt-24 max-w-4xl mx-auto pb-28 md:pb-10 space-y-5 focus:outline-none"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xs mt-0.5" aria-live="polite">
              {categories.length} categories · Organise your products
            </p>
          </div>
        </div>
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: `0 0 0 1px ${ACCENT}20, 0 8px 32px rgba(0,0,0,0.4)`,
              }}
            >
              <div
              ...
              <div className="space-y-3">
                ...
                <label htmlFor="new-category-parent" className="sr-only">
                  Parent category
                </label>
                <select
                ...
                >
                  <option value="">Top‑level (no parent)</option>
                  {/* ✅ Render the tree hierarchy with indentation */}
      ...
      <div className="space-y-3" role="list" aria-label="Category list">
        {!categories.length ? (
          ...
          >
            ...
            >
              <Plus className="w-4 h-4" aria-hidden="true" /> Create First
              Category
            </button>
          </div>
        ) : (
