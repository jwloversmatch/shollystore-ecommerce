...
const INDEXES = {
  products: [
    {
      key: { isFeatured: 1, isActive: 1, createdAt: -1 },
      name: "featured_active_created",
    },
    {
      key: { category: 1, isActive: 1, createdAt: -1 },
      name: "category_active_created",
    },
  ...
  orders: [
    ...
    {
      key: { status: 1, paymentMethod: 1, createdAt: -1 },
      name: "status_payment_created",
    },
